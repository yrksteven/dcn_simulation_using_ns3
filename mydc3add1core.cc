...
int main (int argc, char *argv[])
{
	...
	PointToPointHelper ptp1,ptp2,ptp3,ptp4;
	...
	NetDeviceContainer devicePtp1,devicePtp2,devicePtp3,devicePtp4;
    ...
    csma.EnablePcap ("Pattern3f n1 to n5", deviceCsmaNodes3.Get (1), true);
    ...
    csma.EnablePcap ("Pattern3f n6 to n2", deviceCsmaNodes1.Get (2), true);
	...
	csma.EnablePcap ("Pattern3f n3 to n7", deviceCsmaNodes4.Get (1), true);
	...
	csma.EnablePcap ("Pattern3f n8 to n4", deviceCsmaNodes2.Get (2), true);
