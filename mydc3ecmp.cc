...
int main (int argc, char *argv[])
{
    ...
    csma.EnablePcap ("Pattern3ecmp n2 to n1 ", deviceCsmaNodes1.Get (2), true);
    ...
    csma.EnablePcap ("Pattern3ecmp n3 to n1", deviceCsmaNodes2.Get (1), true);
    ...
    csma.EnablePcap ("Pattern3ecmp n4 to n1", deviceCsmaNodes2.Get (2), true);
    ...
    csma.EnablePcap ("Pattern3ecmp n5 to n1", deviceCsmaNodes3.Get (1), true);
    ...
    csma.EnablePcap ("Pattern3ecmp n6 to n1", deviceCsmaNodes3.Get (2), true);
    ...
    csma.EnablePcap ("Pattern3ecmp n7 to n1", deviceCsmaNodes4.Get (1), true);
    ...
    csma.EnablePcap ("Pattern3ecmp n8 to n1", deviceCsmaNodes4.Get (2), true);
